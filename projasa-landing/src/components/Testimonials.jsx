...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="w-full py-24 relative z-10 bg-transparent overflow-hidden">
      {/* Header */}
      <div className="reveal flex flex-col items-center text-center mb-16 px-6">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white border border-slate-200 shadow-sm mb-6">
          <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-slate-700"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>
          <span className="text-xs font-semibold text-slate-700 tracking-wide">Ulasan Google</span>
        </div>
