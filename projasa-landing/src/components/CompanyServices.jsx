...
export default function CompanyServices({ companyName, onBack }) {
  const company = servicesData[companyName]
      ...
      <div className="max-w-7xl mx-auto px-6 pt-8 pb-8">
        ...
        <div className="flex flex-col md:flex-row items-start gap-6 mb-8">
          <div className="w-20 h-20 rounded-2xl overflow-hidden shadow-md flex-shrink-0">
            <img src={company.image} alt={companyName} className="w-full h-full object-cover" />
          </div>
          <div>
            <h2 className="text-3xl md:text-4xl font-extrabold text-brand-dark tracking-tight mb-2">
              {companyName}
            </h2>
